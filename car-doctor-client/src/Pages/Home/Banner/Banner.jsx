  ...
  return (
    <div className="carousel w-full h-[600px] ">
      <div id="slide1" className="carousel-item relative w-full overflow-hidden ">
        ...
        />
        <div className="absolute py-64 px-32 top-1/2 flex -translate-y-1/2 transform justify-start gap-3  text-white  bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)] ">
